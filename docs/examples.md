...
```bash
# Use your preferred coding agent (claude, opencode, copilot, etc.)
...
claude --agent Anubis --prompt "Review OrderRepository for query patterns"
...
# Handoff to specialized agent (if available):
